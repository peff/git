...
static ssize_t read_istream_filtered(struct git_istream *st, char *buf, size_t sz)
{
...
static ssize_t read_istream_pack_non_delta(struct git_istream *st, char *buf, size_t sz)
{
	size_t total_read = 0;
