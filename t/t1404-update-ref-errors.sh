...
test_expect_success REFFILES 'empty directory should not fool rev-parse' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool for-each-ref' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool create' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool verify' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool 1-arg update' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool 2-arg update' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool 0-arg delete' - <<\EOT
...
test_expect_success REFFILES 'empty directory should not fool 1-arg delete' - <<\EOT
...
test_expect_success REFFILES 'non-empty directory blocks create' - <<\EOT
...
test_expect_success REFFILES 'broken reference blocks create' - <<\EOT
...
test_expect_success REFFILES 'non-empty directory blocks indirect create' - <<\EOT
...
test_expect_success REFFILES 'broken reference blocks indirect create' - <<\EOT
...
test_expect_success REFFILES 'no bogus intermediate values during delete' - <<\EOT
...
test_expect_success REFFILES 'delete fails cleanly if packed-refs file is locked' - <<\EOT
...
test_expect_success REFFILES 'delete fails cleanly if packed-refs.new write fails' - <<\EOT
