...
static int write_each_note(const struct object_id *UNUSED(object_oid),
...
static int prune_notes_helper(const struct object_id *object_oid,
			      const struct object_id *UNUSED(note_oid),
			      char *UNUSED(note_path),
			      void *cb_data)
{
...
int combine_notes_ignore(struct object_id *UNUSED(cur_oid),
